import { g as getControlId, P as PopoverProvider, a as MarkupIcon, s as styled, F as Form, B as Button } from "./blocks-BL10zoPt.js";
import { r as reactExports, R as React, _ as __toESM, a as __commonJS } from "./iframe-Bz2NxXXs.js";
import "./preload-helper-UZRgTS1n.js";
var require_color_name = __commonJS({
  "../../../node_modules/color-name/index.js"(exports$1, module) {
    module.exports = {
...
var require_conversions = __commonJS({
  "../../../node_modules/color-convert/conversions.js"(exports$1, module) {
...
var require_route = __commonJS({
  "../../../node_modules/color-convert/route.js"(exports$1, module) {
...
var require_color_convert = __commonJS({
  "../../../node_modules/color-convert/index.js"(exports$1, module) {
...
var Wrapper = styled.div({
  ...
  let [value, setValue] = reactExports.useState(initialValue || ""), [color, setColor] = reactExports.useState(() => parseValue(value)), [colorSpace, setColorSpace] = reactExports.useState(
  ...
  let realValue = reactExports.useMemo(
    () => getRealValue(value, color, colorSpace).toLowerCase(),
    [value, color, colorSpace]
  ), updateValue = reactExports.useCallback(
    (update) => {
    ...
    [onChange]
  ), cycleColorSpace = reactExports.useCallback(() => {
  ...
  let presets = reactExports.useMemo(() => (presetColors || []).map((preset) => typeof preset == "string" ? parseValue(preset) : preset.title ? { ...parseValue(preset.color), keyword: preset.title } : parseValue(preset.color)).concat(selectedColors).filter(Boolean).slice(-27), [presetColors, selectedColors]), addPreset = reactExports.useCallback(
    (color) => {
  ...
  let debouncedOnChange = reactExports.useCallback(debounce(onChange, 200), [onChange]), { value, realValue, updateValue, color, colorSpace, cycleColorSpace } = useColorInput(
    initialValue,
    debouncedOnChange

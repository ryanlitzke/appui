import { s as styled, l as lightenColor, _ as _extends, b as _objectWithoutPropertiesLoose, r as require_memoizerific } from "./blocks-B-Y4VgmS.js";
import { R as React, r as reactExports, d as ReactDOM2, b as __toESM, e as reactDomExports, f as __commonJS } from "./iframe-Ce3lap89.js";
import "./preload-helper-UZRgTS1n.js";
import "./index-CZZ7UcJw.js";
var require_react_fast_compare = __commonJS({
  "../../node_modules/react-fast-compare/index.js"(exports$1, module) {
...
var require_warning = __commonJS({
  "../../node_modules/warning/warning.js"(exports$1, module) {
...
var EMPTY_MODIFIERS = [], usePopper = function(referenceElement, popperElement, options) {
  options === void 0 && (options = {});
  var prevOptions = reactExports.useRef(null), optionsWithDefaults = {
    onFirstUpdate: options.onFirstUpdate,
    placement: options.placement || "bottom",
    strategy: options.strategy || "absolute",
    modifiers: options.modifiers || EMPTY_MODIFIERS
  }, _React$useState = reactExports.useState({
    styles: {
      popper: {
    ...
    attributes: {}
  }), state = _React$useState[0], setState = _React$useState[1], updateStateModifier = reactExports.useMemo(function() {
    return {
      name: "updateState",
      enabled: true,
      phase: "write",
...
function usePopperTooltip(config, popperOptions) {
  ...
  }, config), defaultModifiers3 = reactExports.useMemo(
    function() {
      return [{
        name: "offset",
        options: {
  ...
  }), _React$useState = reactExports.useState(null), triggerRef = _React$useState[0], setTriggerRef = _React$useState[1], _React$useState2 = reactExports.useState(null), tooltipRef = _React$useState2[0], setTooltipRef = _React$useState2[1], _useControlledState = useControlledState({
    initial: finalConfig.defaultVisible,
    value: finalConfig.visible,
    onChange: finalConfig.onVisibleChange
  }), visible = _useControlledState[0], setVisible = _useControlledState[1], timer = reactExports.useRef();
  ...
  var _usePopper = usePopper(finalConfig.followCursor ? virtualElement : triggerRef, tooltipRef, finalPopperOptions), styles = _usePopper.styles, attributes = _usePopper.attributes, popperProps = _objectWithoutPropertiesLoose(_usePopper, _excluded), update = popperProps.update, getLatest = useGetLatest({
    ...
    tooltipRef,
    finalConfig
  }), isTriggeredBy = reactExports.useCallback(
    function(trigger) {
  ...
  ), hideTooltip = reactExports.useCallback(function() {
...
var { document: document2 } = global, match = (0, import_memoizerific.default)(1e3)(
  ...
  ({
    ...
    withArrows,
    ...props
  }, ref) => React.createElement(Wrapper, { "data-testid": "tooltip", hasChrome, ref, ...props, color }, hasChrome && withArrows && React.createElement(Arrow, { placement, ...arrowProps, color }), children)
);
...
`, WithTooltipPure = ({
  ...
  ), portalTarget = (typeof portalContainer == "string" ? document2.querySelector(portalContainer) : portalContainer) || document2.body, tooltipComponent = isVisible ? React.createElement(
    Tooltip,
    {
      placement: state?.placement,
      ref: setTooltipRef,
  ...
  return React.createElement(React.Fragment, null, React.createElement(Container, { trigger, ref: setTriggerRef, ...props }, children), isVisible && ReactDOM2.createPortal(tooltipComponent, portalTarget));
}, WithToolTipState = ({
  startOpen = false,
  onVisibleChange: onChange,
  ...rest
}) => {
  let [tooltipShown, setTooltipShown] = reactExports.useState(startOpen), onVisibilityChange = reactExports.useCallback(
    (visibility) => {
  ...
  }), React.createElement(WithTooltipPure, { ...rest, visible: tooltipShown, onVisibleChange: onVisibilityChange });
...
), React.createElement(WithTooltipPure, { "data-deprecated": "WithTooltipPure", ...props })), DeprecatedState = (props) => (deprecate(
  "WithToolTipState is deprecated and will be removed in Storybook 11. Please use WithTooltip instead."
), React.createElement(WithToolTipState, { "data-deprecated": "WithToolTipState", ...props }));
export {
  Tooltip,

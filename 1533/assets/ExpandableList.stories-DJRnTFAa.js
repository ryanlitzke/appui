...
import { a3 as ExpandableBlock } from "./appui-react-B_TRJJtR.js";
...
ExpandableList.__docgenInfo = { "description": "ExpandableList React component is a container for ExpandableBlock components.\n@public\n@deprecated in 4.12.0. Use a custom container and manage {@link https://itwinui.bentley.com/docs/expandableblock expandable block} state manually.", "methods": [], "displayName": "ExpandableList", "props": { "className": { "required": false, "tsType": { "name": "string" }, "description": "Custom CSS class name" }, "style": { "required": false, "tsType": { "name": "ReactCSSProperties", "raw": "React.CSSProperties" }, "description": "Custom CSS style properties" }, "itemId": { "required": false, "tsType": { "name": "string" }, "description": "Optional unique identifier for item. If defined it will be added to DOM Element attribute as data-item-id" }, "defaultActiveBlock": { "required": false, "tsType": { "name": "number" }, "description": "Index of the default active block", "defaultValue": { "value": "0", "computed": false } }, "singleExpandOnly": { "required": false, "tsType": { "name": "boolean" }, "description": "Indicates whether to allow only one expanded block", "defaultValue": { "value": "false", "computed": false } }, "singleIsCollapsible": { "required": false, "tsType": { "name": "boolean" }, "description": "Indicates whether the single expanded block is collapsible" }, "children": { "required": false, "tsType": { "name": "ReactReactNode", "raw": "React.ReactNode" }, "description": "Content" } } };
const meta = {

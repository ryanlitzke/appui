import { l as forwardRef, j as jsxRuntimeExports, m as Role, c as classnames, r as reactExports, u as useLatestRef, n as useSafeContext, o as useRootNode, p as getOwnerDocument, s as spriteSheetId, q as parseDOM, H as HtmlSanitizerContext, R as React } from "./iframe-C98IYynM.js";
import { u as StagePanelState, a4 as BadgeType, W as WidgetState, S as SvgPlaceholder } from "./appui-react-C9pNnkoL.js";
...
function useNormalizedHrefBase(rawHref) {
  ...
  const subscribe = reactExports.useCallback(
    (notify) => {
      ...
      const cache = spriteSheet[/* @__PURE__ */ Symbol.for("🥝")]?.icons;
      if (!cache) return () => {
      };
